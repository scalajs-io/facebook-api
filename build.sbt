...
lazy val publishingSettings = Seq(
  ...
  pomExtra :=
    <url>https://github.com/scalajs-io/facebook-api</url>
      <licenses>
        <license>
      ...
      <scm>
        <connection>scm:git:github.com/scalajs-io/facebook.git</connection>
        <developerConnection>scm:git:git@github.com:scalajs-io/facebook.git</developerConnection>
        <url>github.com/scalajs-io/facebook.git</url>
      </scm>
      <developers>
        <developer>
          <id>ldaniels528</id>
